...
namespace MicroserviceSolution.AdministrationService.EntityFrameworkCore;
        ...
        var builder = new ConfigurationBuilder()
            .SetBasePath(
                Path.Combine(
                    ...
                    $"..{Path.DirectorySeparatorChar}MicroserviceSolution.AdministrationService.HttpApi.Host"
                )
            )
