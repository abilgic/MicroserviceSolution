...
namespace MicroserviceSolution.Shared.Hosting.Microservices;
...
public class MicroserviceSolutionSharedHostingMicroservicesModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services
            .AddDataProtection()
            .SetApplicationName("MicroserviceSolution")
            .PersistKeysToStackExchangeRedis(redis, "MicroserviceSolution-Protection-Keys");
