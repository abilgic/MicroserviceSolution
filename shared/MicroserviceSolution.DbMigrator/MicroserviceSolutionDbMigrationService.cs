...
public class MicroserviceSolutionDbMigrationService : ITransientDependency
{
    private readonly ILogger<MicroserviceSolutionDbMigrationService> _logger;
    private readonly ITenantRepository _tenantRepository;
    private readonly IDataSeeder _dataSeeder;
    private readonly ICurrentTenant _currentTenant;
    private readonly IUnitOfWorkManager _unitOfWorkManager;

    public MicroserviceSolutionDbMigrationService(
        ILogger<MicroserviceSolutionDbMigrationService> logger,
