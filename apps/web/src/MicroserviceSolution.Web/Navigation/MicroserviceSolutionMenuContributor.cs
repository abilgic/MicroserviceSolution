...
using MicroserviceSolution.AdministrationService.Permissions;
using MicroserviceSolution.Localization;
using MicroserviceSolution.ProductService.Web.Menus;
...
public class MicroserviceSolutionMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public MicroserviceSolutionMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<MicroserviceSolutionResource>();

        //Home
        context.Menu.AddItem(
            new ApplicationMenuItem(
                MicroserviceSolutionMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fa fa-home",
                order: 0
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                MicroserviceSolutionMenus.HostDashboard,
                l["Menu:Dashboard"],
                "~/HostDashboard",
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                MicroserviceSolutionMenus.TenantDashboard,
                l["Menu:Dashboard"],
                "~/Dashboard",
                icon: "fa fa-line-chart",
                order: 1
