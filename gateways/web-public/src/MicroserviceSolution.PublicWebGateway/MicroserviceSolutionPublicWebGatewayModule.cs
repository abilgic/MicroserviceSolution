...
using MicroserviceSolution.Shared.Hosting.Gateways;
using Swashbuckle.AspNetCore.SwaggerUI;
using Volo.Abp;
using Volo.Abp.Modularity;
using Yarp.ReverseProxy.Configuration;

namespace MicroserviceSolution.PublicWebGateway;

[DependsOn(
    typeof(MicroserviceSolutionSharedHostingGatewaysModule)
)]
public class MicroserviceSolutionPublicWebGatewayModule : AbpModule
{
